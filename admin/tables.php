                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $result['nama']  ?></td>
                                                <td><?= $result['kelas']  ?></td>
                                                <td><a href="edit-user.php?nim=<?= $result['nim'] ?>">Edit</a> | <a onclick="return confirm('Are you sure to delete this data?')" href="delete-user.php?nim=<?= $result['nim'] ?>">Delete</a></td>
                                            </tr>
                                        <?php endwhile; ?>
                                    </tbody>
                                </table>
...
<?php
    ...
    echo "You can't access this page unless you <a href='login.php'>Log in</a> as an Admin.";
}
?>